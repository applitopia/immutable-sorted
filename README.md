...
Current version [immutable-sorted@0.2.2](https://github.com/applitopia/immutable-sorted/releases/tag/v0.2.2) is an extension of [immutable-js@4.0.0-rc.9](https://github.com/facebook/immutable-js/releases/tag/v4.0.0-rc.9).
